...
Contributors: elemntor, KingYes, ariel.k, bainternet, Foliovision
...
Hello Elementor theme without Elementor.

== Description ==

Goodbye Elementor is a lightweight and minimalist WordPress theme. The theme is free, open-source, and designed for users who want a flexible, easy-to-use, and customizable website.

The theme's main focus is on providing a solid foundation. It is optimized for speed and performance, and its simplicity and flexibility make it a great choice for both beginners and experienced website designers.
...
Goodbye Elementor bundles the following third-party resources:
